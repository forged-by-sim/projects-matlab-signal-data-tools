...
📄 `a-simple-function-practice.m`  
🖼 `a-simple-function-output.png`
...
### ▶️ Multiple Outputs  
Created a function that returns multiple results from a single input — showcasing MATLAB’s ability to unpack tuples.  
📄 `multiple-outputs-practice.m`
...
🖼 `corners-function-output.png`  
🖼 `corners-function-tests-passed.png`

---

### ▶️ Taxi Fare Function  
...
🖼 `taxi-fare-function-output.png`  
🖼 `taxi-fare-function-tests-passed.png`
...
Being able to test logic through well-formed inputs and outputs also solidified clean design habits — essential for future modules involving branching, conditionals, and larger simulation flows.

> 💬 *"From repeated commands to reusable logic — this was MATLAB’s upgrade moment."*
